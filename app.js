...
//**2 ve 3 te Konsola objenin tamamı yazdırıldı**//
...
for (let product of products) {
  if (product.name.charAt(0) === "A") {
    startWithA.push(product.name);
...
console.log("Soru#3");
for (let product of products) {
  if (product.name.charAt(product.name.length - 1) === "a") {
    endWithA.push(product.name);
    console.log(product);
  }
}
...
for (let product of products) {
  //Soru 1
  if (product.unitPrice >= 30 && product.unitPrice <= 100) {
    adet++;
  }
...
console.log("Soru#1");
divOne.innerText = "Soru#1 : " + adet;
ansContainer.appendChild(divOne);
console.log(adet);

divTwo.innerText = "Soru#2 : " + startWithA;
ansContainer.appendChild(divTwo);

divThree.innerText = "Soru#3 : " + endWithA;
ansContainer.appendChild(divThree);

console.log("Soru#4");
divFour.innerText = "Soru#4 : " + productName;
ansContainer.appendChild(divFour);
console.log(productName);

console.log("Soru#5");
divFive.innerText = "Soru#5 : " + countDiscontinued;
ansContainer.appendChild(divFive);
